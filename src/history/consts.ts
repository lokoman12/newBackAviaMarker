...
export const TOI_HISTORY_TABLE_NAME = 'toi_history';

export const METEO_HISTORY_TABLE_NAME = 'meteo_history';

export const OMNICOM_HISTORY_TABLE_NAME = 'omnicom_history';

export const STANDS_HISTORY_TABLE_NAME = 'stands_history';

export const AZNB_HISTORY_TABLE_NAME = 'aznb_history';
